module.exports = {
  ...
  JAIL_BAIL: 200,
  HALL_FEE: 200,
  CASINO_MAX_BET_RATIO: 0.5,
  MORTGAGE_RATIO: 0.7,
  LIQUIDATION_RATIO: 0.5,

  mapTiles: [
    { id: 1, type: 'start', name: '起点', icon: '🚀', position: { row: 0, col: 0 }, direction: 'right' },
    { id: 2, type: 'property', name: '解放碑', block: '渝中区', price: 420, position: { row: 0, col: 1 }, direction: 'right' },
    { id: 3, type: 'fate', name: '命运', icon: '🔮', position: { row: 0, col: 2 }, direction: 'right' },
    { id: 4, type: 'property', name: '洪崖洞', block: '渝中区', price: 360, position: { row: 0, col: 3 }, direction: 'right' },
    { id: 5, type: 'property', name: '来福士', block: '渝中区', price: 330, position: { row: 0, col: 4 }, direction: 'right' },
    { id: 6, type: 'station', name: '车站A', icon: '🚂', position: { row: 0, col: 5 }, direction: 'right' },
    { id: 7, type: 'property', name: '十八梯', block: '渝中区', price: 290, position: { row: 0, col: 6 }, direction: 'right' },
    { id: 8, type: 'property', name: '茶园', block: '南岸区', price: 340, position: { row: 0, col: 7 }, direction: 'right' },
    { id: 9, type: 'shop', name: '道具店', icon: '🛒', position: { row: 0, col: 8 }, direction: 'right' },
    { id: 10, type: 'property', name: '南滨路', block: '南岸区', price: 380, position: { row: 0, col: 9 }, direction: 'right' },
    { id: 11, type: 'property', name: '南山', block: '南岸区', price: 330, position: { row: 0, col: 10 }, direction: 'right' },
    { id: 12, type: 'property', name: '磁器口', block: '沙坪坝区', price: 360, position: { row: 0, col: 11 }, direction: 'right' },
    { id: 13, type: 'jail', name: '监狱', icon: '🔒', position: { row: 0, col: 12 }, direction: 'down' },
    { id: 14, type: 'chance', name: '机会', icon: '🎴', position: { row: 1, col: 12 }, direction: 'down' },
    { id: 15, type: 'property', name: '大学城', block: '沙坪坝区', price: 350, position: { row: 2, col: 12 }, direction: 'down' },
    { id: 16, type: 'park', name: '公园', icon: '🌳', position: { row: 3, col: 12 }, direction: 'down' },
    { id: 17, type: 'property', name: '重庆西站', block: '沙坪坝区', price: 340, position: { row: 4, col: 12 }, direction: 'down' },
    { id: 18, type: 'auction', name: '拍卖行', icon: '⚖️', position: { row: 5, col: 12 }, direction: 'down' },
    { id: 19, type: 'property', name: '半山', block: '九龙坡区', price: 320, position: { row: 6, col: 12 }, direction: 'down' },
    { id: 20, type: 'property', name: '万象城', block: '九龙坡区', price: 380, position: { row: 7, col: 12 }, direction: 'down' },
    { id: 21, type: 'hall', name: '市政厅', icon: '🏛️', position: { row: 8, col: 12 }, direction: 'left' },
    { id: 22, type: 'property', name: '欢乐谷', block: '两江新区', price: 410, position: { row: 8, col: 11 }, direction: 'left' },
    { id: 23, type: 'fund', name: '基金', icon: '💰', position: { row: 8, col: 10 }, direction: 'left' },
    { id: 24, type: 'property', name: '中央公园', block: '两江新区', price: 370, position: { row: 8, col: 9 }, direction: 'left' },
    { id: 25, type: 'fate', name: '命运', icon: '🔮', position: { row: 8, col: 8 }, direction: 'left' },
    { id: 26, type: 'property', name: '光环', block: '两江新区', price: 320, position: { row: 8, col: 7 }, direction: 'left' },
    { id: 27, type: 'property', name: '园博园', block: '两江新区', price: 300, position: { row: 8, col: 6 }, direction: 'left' },
    { id: 28, type: 'shop', name: '道具店', icon: '🛒', position: { row: 8, col: 5 }, direction: 'left' },
    { id: 29, type: 'property', name: '缙云山', block: '北碚区', price: 390, position: { row: 8, col: 4 }, direction: 'left' },
    { id: 30, type: 'property', name: '北温泉', block: '北碚区', price: 340, position: { row: 8, col: 3 }, direction: 'left' },
    { id: 31, type: 'station', name: '车站B', icon: '🚂', position: { row: 8, col: 2 }, direction: 'left' },
    { id: 32, type: 'property', name: '金刀峡', block: '北碚区', price: 320, position: { row: 8, col: 1 }, direction: 'left' },
    { id: 33, type: 'casino', name: '赌场', icon: '🎰', position: { row: 8, col: 0 }, direction: 'up' },
    { id: 34, type: 'property', name: '巴滨路', block: '巴南区', price: 400, position: { row: 7, col: 0 }, direction: 'up' },
    { id: 35, type: 'park', name: '公园', icon: '🌳', position: { row: 6, col: 0 }, direction: 'up' },
    { id: 36, type: 'property', name: '南温泉', block: '巴南区', price: 340, position: { row: 5, col: 0 }, direction: 'up' },
    { id: 37, type: 'property', name: '鱼洞', block: '巴南区', price: 310, position: { row: 4, col: 0 }, direction: 'up' },
    { id: 38, type: 'chance', name: '机会', icon: '🎴', position: { row: 3, col: 0 }, direction: 'up' },
    { id: 39, type: 'property', name: '华生园', block: '大渡口区', price: 370, position: { row: 2, col: 0 }, direction: 'up' },
    { id: 40, type: 'property', name: '白居寺', block: '大渡口区', price: 330, position: { row: 1, col: 0 }, direction: 'up' }
  ],
